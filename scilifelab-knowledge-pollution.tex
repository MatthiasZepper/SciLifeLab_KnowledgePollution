...
\institute{SciLifeLab Tech Group Meeting - AI Network}
...
\begin{frame}{Lessons learned}
	\metroset{block=fill}
		\begin{exampleblock}{Aggravation}
			\begin{itemize}
				\item The appointment was decided Sunday night, when news rooms were thinly staffed.
				\item Print deadline had just passed, online media rushed to get the news out 
...
\begin{frame}{Some humans want to mislead, some specifically AI}
	\begin{columns}[T,onlytextwidth]
		\hspace*{-0.7cm} 
		...
		\end{figure}
		{\small Result of using \emph{Google's Banana Pro} model to visualize banana-assisted voltage stabilization.$\rightarrowtail$}
...
\begin{frame}{Political meddling with public health authority}
	\begin{figure}
...
\begin{frame}[standout]{We need to talk...}
	\begin{center}
		\emph{Truth}
	\end{center}
\end{frame}
